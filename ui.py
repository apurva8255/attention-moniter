"""
ui.py
Light-themed desktop UI built with CustomTkinter.
...
class AttentionMonitorUI(ctk.CTk):
    ...
    def _build_header(self):
        ...
        self.start_btn = ctk.CTkButton(
            ...
            fg_color=ACCENT_CYAN, hover_color="#00695c",
        ...
        self.stop_btn = ctk.CTkButton(
            ...
            fg_color=ACCENT_RED, hover_color="#b71c1c",
            text_color="#ffffff", font=ctk.CTkFont(weight="bold"),
        ...
        self.train_btn = ctk.CTkButton(
            ...
            fg_color=ACCENT_PURPLE, hover_color="#4a00b0",
            text_color="#ffffff", font=ctk.CTkFont(weight="bold"),
        ...
        self.report_btn = ctk.CTkButton(
            ...
            fg_color=ACCENT_BLUE, hover_color="#1558b0",
            text_color="#ffffff",
    ...
    def _build_main_content(self):
        self.main_pane = ctk.CTkFrame(self, fg_color=BG_LIGHT)
        self.main_pane.pack(fill="both", expand=True, padx=10, pady=5)

        left_outer = ctk.CTkFrame(self.main_pane, fg_color=BG_LIGHT, width=300)
        left_outer.pack(side="left", fill="y", padx=(0, 5))
        left_outer.pack_propagate(False)

        left = ctk.CTkScrollableFrame(left_outer, fg_color=BG_LIGHT, width=285,
        ...
        right = ctk.CTkFrame(self.main_pane, fg_color=BG_LIGHT)
    ...
    def _build_tabs(self, parent):
        self.tabview = ctk.CTkTabview(
            ...
            segmented_button_selected_hover_color="#1558b0",
            text_color=TEXT_PRIMARY
        )
    ...
    def _build_models_tab(self):
        ...
        # Model comparison charts — one at a time with toggle buttons
        from dashboard import ModelComparisonDashboard
        self.model_dashboard = ModelComparisonDashboard(self.tab_models, width=870, height=340)
    ...
    def _build_log_tab(self):
        self.log_text = ctk.CTkTextbox(
            self.tab_logs, fg_color=BG_PANEL,
            text_color=TEXT_PRIMARY,
    ...
    def _build_status_bar(self):
        bar = ctk.CTkFrame(self, fg_color=ACCENT_BLUE, height=28, corner_radius=0)
    ...
    def update_metrics(self, result: dict):
        ...
        self.status_label.configure(text=f"● {label.upper()} ATTENTION", text_color=color)
        ...
        for key, (lbl, unit) in self._metric_labels.items():
            ...
            text = f"{val:.2f} {unit}".strip() if isinstance(val, float) else f"{val} {unit}".strip()
    ...
    def show_alert_popup(self, score: float, label: str):
        def _show():
            ...
            ctk.CTkLabel(self._alert_popup,
                         text="⚠ LOW ATTENTION DETECTED",
                         font=ctk.CTkFont(size=16, weight="bold"),
                         text_color=ACCENT_RED).pack(pady=(20, 5))

            ctk.CTkLabel(self._alert_popup,
                         text=f"Score: {score:.1f}  |  Status: {label}",
                         font=ctk.CTkFont(size=13),
                         text_color=ACCENT_ORANGE).pack(pady=5)

            ctk.CTkLabel(self._alert_popup,
                         text="Please refocus on your task.",
                         font=ctk.CTkFont(size=11),
                         text_color=TEXT_DIM).pack(pady=5)

            ctk.CTkButton(self._alert_popup, text="Dismiss",
                          fg_color=ACCENT_RED, hover_color="#b71c1c",
                          text_color="#ffffff",
                          command=self._alert_popup.destroy).pack(pady=15)
