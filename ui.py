...
class AttentionMonitorUI(ctk.CTk):
    ...
    def _build_models_tab(self):
        ...
        from dashboard import ModelComparisonChart
        self.model_chart = ModelComparisonChart(chart_frame, width=850, height=280)
    ...
    def _on_train_done(self, results: dict):
        def _update():
            ...
            self._log(f"✅ ML training complete. Best: {self.controller.get_best_model_name()}")
